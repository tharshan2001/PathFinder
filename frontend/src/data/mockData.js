...
export const mockCourses = [
  {
    ...
    description: 'Master React 18, Hooks, Redux, Next.js, and build real-world projects.',
  ...
  },
  {
    ...
    description: 'Learn modern UI/UX design principles, Figma, prototyping.',
    category: 'Design',
    level: 'Intermediate',
  ...
  },
  {
    ...
    description: 'Become a full-stack developer with Node.js, Express, MongoDB, React.',
    category: 'Web Development',
    level: 'Advanced',
  ...
  },
  {
    ...
    description: 'Learn essential cybersecurity concepts, ethical hacking, network security.',
...
export const mockJobs = [
  ...
  },
  {
    ...
    requirements: ['MS/PhD in related field', 'Python expertise', 'ML framework experience'],
  ...
  },
  {
    ...
    requirements: ['AWS/Azure certification', '7+ years experience', 'Enterprise architecture background'],
  ...
  },
  {
    ...
    requirements: ['5+ years DevOps experience', 'CI/CD expertise', 'Cloud platform knowledge'],
